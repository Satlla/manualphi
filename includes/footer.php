...
<footer class="text-center text-lg-start bg-white text-muted">
      ...
      <div class="row mt-3">
        ...
        <div class="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
          ...
          <h6 class="text fw-bold mb-4">
            <i class=" header-purple-gradien"> Manualphi.</i>
          </h6>
          <p>
            La plataforma que facilita la vida de miles de anfitriones en la gestión de apartamentos turísticos. 
          </p>
        </div>
        <!-- Grid column -->
        ...
        <div class="col-md-3 col-lg-2 col-xl-2 mx-auto mb-4">
          ...
          <p>
            <a href="#!" class="text-reset">Cómo funciona</a>
          </p>
          <p>
        ...
        <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
          ...
          <p>
            <a href="#!" class="text-reset">Asistencia Técnica</a>
          </p>
          <p>
  ...
  <div class="text-center p-4" style="background-color: rgba(0, 0, 0, 0.025);">
    © 2022 Copyright:
    <a class="text-reset fw-bold" href="https://mdbootstrap.com/">www.manualphi.com</a>
  </div>
  <!-- Copyright -->
</footer>
<!-- Footer -->